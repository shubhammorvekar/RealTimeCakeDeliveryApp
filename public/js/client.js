...
function initAdmin(socket) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().get("/admin/orders", {
    ...
    orders = res.data; // console.log(orders[0].items);
...
function updateCart(cake) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/update-cart", cake).then(function (res) {
    cartCounter.innerText = res.data.totalQty; //add cart popup
...
var alertMsg = document.querySelector("#successO");
...
var socket = io();
(0,_admin_js__WEBPACK_IMPORTED_MODULE_2__.initAdmin)(socket); //join

if (order) {
  socket.emit("join", "order_".concat(order._id));
}

var adminPathName = window.location.pathname;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrealtime_tracker"] = self["webpackChunkrealtime_tracker"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["public/css/style"], () => (__webpack_require__("./resources/js/client.js")))
